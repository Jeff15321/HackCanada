...
export const getServerSideProps: GetServerSideProps = async () => {
  try {
    if (!process.env.MONGODB_URI) {
      return {
        props: { isConnected: false, error: "MongoDB URI not configured" },
      };
    }
    ...
    console.error(e);
    return {
      props: { isConnected: false, error: "Failed to connect to MongoDB" },
    };
  }
};
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col place-items-center gap-12">
        ...
        {isConnected ? (
          <h2 className="text-lg text-green-500">Connected to MongoDB</h2>
        ) : (
