...
instructional_files = ["./documents/WIT_ESSAY_KEY_POINTS.pdf"] # files to be read in full
supplementary_files = ["./documents/A_Dolls_House.pdf"] # files to be rag'd and take exerpts from
