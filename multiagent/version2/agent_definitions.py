agent_definitions = {
    ...
    "Process Creator Agent": {
        ...
        "function": "In addition to the current information about task, role, and type of task, Outline the working steps that need to be done in order to accomplish the task specified in the prompt. Each area of work should be its own section with bulletin points outlining the steps that are to be conducted to do each area of work. Return the prompt and in the formatting of Task: ... \n Role: ... \n Type of Task: ... \n Working Steps: ...."
    },
    "Search Agent": {
        "name": "Search Agent",
