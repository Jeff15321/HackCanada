# changes from version 3: commented out agents no longer in use, removed the final formatting specific requirements (instead just telling them whether or not to keep the same formatting as the prompt given to them) since they don't make sense anymore
...
agent_definitions = {
    ...
    #     "function": "Ensure that the prompt is written with sufficient consideration of the context of the role to be fully understood and appropriately answered. Keep the formating of the prompt as it currently is."
    # },
    "Task Context Agent": {
        "name": "Task Context Agent",
        "role": "You are an agent that adds to the prompt based on the context of the task and context of the user, setting the stage for responses that are informed by relevant background information of the user's role.",
        "function": "Ensure that the prompt is written with sufficient consideration of the context of the task and context to be fully understood and appropriately answered. Keep the formating of the prompt as it currently is."
    },
    "Clarity Agent": {
        "name": "Clarity Agent",
        "role": "You are an agent that enhances the clarity and understandability of the prompt.",
        "function": "Reviews the prompt for clarity, checking for ambiguous language, confusing structure, and overly complex vocabulary. Simplify sentences and clarifies intentions. Keep the formating of the prompt as it currently is."
    },
    "Relevance Agent": {
        ...
        "function": "Assesses whether the prompt directly addresses the core elements of the user's question or task. Remove extraneous details and sharpens the focus. Keep the formating of the prompt as it currently is."
    },
    "Precision Agent": {
        ...
        "function": "Tighten the prompt to target very specific information or answers, facilitating more detailed and targeted responses. Keep the formating of the prompt as it currently is."
    },
    "Brevity Agent": {
        "name": "Brevity Agent",
        "role": "",
        "function": "Trim down the prompt to its most essential elements, removing any redundant words or phrases and ensuring that every word serves a purpose. Keep the formating of the prompt as it currently is."
    },
    "Consolidator Agent": {
        ...
        "function": "Review suggestions from all other agents merge the elements from multiple suggestions into a single refined prompt. Give me back the final prompt and nothing else. Do not add anything like 'here is the final prompt' or 'this is the final prompt' etc..  Keep the formating of the prompt as it currently is."
    },
    "Search Agent": {
        "name": "Search Agent",
    ...
    "Search Consolidator Agent": {
        ...
        "function": "Review the relevant information given by the source agents and merge the elements from them into the single refined prompt. Make sure to keep all the relevant information. Give me back the final prompt and nothing else. Do not add anything like 'here is the final prompt' or 'this is the final prompt' etc..  Keep the formating of the prompt as it currently is."
    },
    "Completeness Agent": {
        ...
        "function": "Review the final consolidated prompt and ensure it contains all necessary elements from the original task description. Adjust as needed to include any missing aspects, apart from making the prompt better the prompt should contain the same meaning as that of the original task. Give me back the final prompt and nothing else. Do not add anything like 'here is the final prompt' or 'this is the final prompt' etc.. Keep the formating of the prompt as it currently is."
    },
}